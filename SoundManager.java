...
public class SoundManager {				// a Singleton class
	...
	private SoundManager () {
		...
		clip = loadClip("sounds/dead.wav");
		clips.put("dead", clip);		// played when a special sprite 
							//   makes an appearance

		clip = loadClip("sounds/newlevel.wav");
		clips.put("new", clip);		// played for bird-flying animation

		clip = loadClip("sounds/money.wav");
		clips.put("money", clip);		// played for bird-flying animation
		clip = loadClip("sounds/Doubles.wav");
		clips.put("eat", clip);		// played for bird-flying animation
	}
	...
	public Clip getClip (String title) {
		...
		public void stopAllSounds() {
			//for clip in clips
			//if clip is not null, stop the clip
			if (clips != null) {
